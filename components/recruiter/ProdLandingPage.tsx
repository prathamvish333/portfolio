      ...
      <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center px-6 md:px-20 lg:px-32 bg-[#0b1120] grid-bg overflow-hidden pt-24 md:pt-20">
        ...
        >
          ...
          >
            ...
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-teal-500/5 border border-teal-500/20">
          ...
          >
            {isRecruiterMode && (
              <button onClick={() => setRecruiterMode(false)} className="px-6 py-4 bg-[#0d9488] text-white hover:bg-[#14b8a6] rounded-2xl font-heading text-[10px] font-black tracking-widest uppercase transition-all shadow-lg flex items-center justify-center gap-3">
                <span>Start journey of Interstellar</span>
