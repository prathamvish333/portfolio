          ...
          >
            {!isRecruiterMode && (
              <>
                ...
                <Link href="/cinematic" className="px-6 py-4 bg-transparent border border-teal-500/30 text-teal-400 hover:bg-teal-500/10 hover:border-teal-500 hover:shadow-[0_0_15px_rgba(13,148,136,0.3)] rounded-2xl font-heading text-[10px] font-black tracking-widest uppercase transition-all flex items-center justify-center gap-3 relative overflow-hidden group">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-teal-500/10 to-transparent translate-x-[-100%] group-hover:animate-[shimmer_1.5s_infinite]" />
                  <span>Dive into Space</span>
              ...
              <div className="grid lg:grid-cols-5 gap-12">
                  ...
                  <div>
                    ...
                    <ul className="space-y-6">
                      <li className="flex gap-4">
                        ...
                        <div>
                          <p className="text-[#e5e7eb] font-bold md:text-lg mb-1">AI Infrastructure Orchestration (MCP)</p>
                          <p className="text-[#9ca3af] text-sm md:text-base leading-relaxed">Developed and exposed 50+ modular infrastructure tools (e.g. service monitoring, Salt states, consumer lag tracking) using FastAPI for LLM orchestration. Integrated Piko reverse tunnels and a custom AuthZ layer to securely execute tool actions via the Salt Master API.</p>
                        </div>
                      </li>
                      <li className="flex gap-4">
                        <div className="w-1.5 h-1.5 rounded-full bg-teal-500 mt-2 shrink-0 shadow-[0_0_10px_rgba(13,148,136,0.5)]" />
                        <div>
                          <p className="text-[#e5e7eb] font-bold md:text-lg mb-1">Cross-Platform Automation</p>
                          <p className="text-[#9ca3af] text-sm md:text-base leading-relaxed">Engineered modular automation workflows using Python and Robot Framework. Implemented dynamic execution logic across Linux (SSH/SCP) and Windows (WinRM), increasing delivery speed by 60% and reducing manual execution by 50%.</p>
                        </div>
                      </li>
                      <li className="flex gap-4">
                        <div className="w-1.5 h-1.5 rounded-full bg-teal-500 mt-2 shrink-0 shadow-[0_0_10px_rgba(13,148,136,0.5)]" />
                        <div>
                          <p className="text-[#e5e7eb] font-bold md:text-lg mb-1">System Optimization</p>
                          <p className="text-[#9ca3af] text-sm md:text-base leading-relaxed">Designed OS-detection logic and secure, centralized storage upload pipelines with clickable UI retrieval, reducing file retrieval time by 80% and manual post-run handling by 60%.</p>
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                  <div className="bg-[#0b1120]/50 rounded-2xl p-6 border border-white/5 h-full">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Python', 'FastAPI', 'Kubernetes', 'AI MCP', 'Piko Tunnels', 'SaltStack', 'Docker', 'Robot Framework', 'CI/CD'].map(tech => (
